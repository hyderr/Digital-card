...
export default function Dark(props){
    return(
        ...
        <>
            ...
            <div className='foot'>
                <a className='social' href='https://instagram.com'rel="noreferrer" target="_blank" ><FaInstagram   size={30} /></a>
                <a className='social' href='https://facebook.com'rel="noreferrer" target="_blank"><FaFacebook  size={30} /></a>
                <a className='social' href='https://github.com'rel="noreferrer" target="_blank"><FaGithub  size={30} /></a>
            </div> 
